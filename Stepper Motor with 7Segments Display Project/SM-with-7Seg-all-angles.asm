...
STORE_FUN MACRO    ;THIS FUNCTION WILL STORE THE NUMBERS FROM STACK AND STORE IT TO DX
MOV BX , 1
MOV DX , 0
POP AX
MUL BX
...
ANGLE_FUN MACRO ; ANGEL WILL BE STORED IN CX
MOV AX , 512
MUL DX
MOV CX , 360
DIV CX
...
MOV AL , 7FH   ; DISPLAYING - ON 7 SEGMENT DISPLAY 83H
MOV DX , 8000H
OUT DX , AL
...
MOV SI , OFFSET CUMULATIVE_ANGLE
MOV [SI] , DX
PUSH DX
