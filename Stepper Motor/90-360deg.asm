    ...
    ROTATER:
    MOV CX , 512  ;The number of Steps = 512 in CX
    ;LOOP WILL REPEAT THE PROCESS FOR 512 Times which will moves the stepper motor 512 steps (360deg)
    LPP1:
    ...
    PUSH CX ;Push CX to stack to save it from cahnging due to the delay process
    ;Simple delay
    MOV CX , 05FFH
    DELAY:
    LOOP DELAY
    
    POP CX    ;Pop CX from the stack again 
    LOOP LPP1 ;Jump at LPP1 until CX = 0
    JMP LP    ;jump again to LP and repeat the process
    
    
    ROTATEL:
    MOV CX , 128     ;The number of Steps = 128 in CX
    ;LOOP WILL REPEAT THE PROCESS FOR 128 Times which will moves the stepper motor 128 steps (90deg)
    LPP2:
    ...
    POP CX   ;Pop CX from the stack again 
    LOOP LPP2  ;Jump at LPP2 until CX = 0
    JMP LP   ;jump again to LP and repeat the process
